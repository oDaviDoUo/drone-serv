...
export function EventCalendar({
  ...
  return (
    <div
      className="flex flex-col border-none has-data-[slot=month-view]:flex-1"
      style={
        {
      ...
      <CalendarDndProvider onEventUpdate={handleEventUpdate}>
        <div className={cn("flex items-center justify-between p-2 sm:p-4", className)}>
          ...
          <div className="flex items-center gap-2">
            {/* <DropdownMenu>   POTOM DOBAVIM ESLI NUZNO BUDET
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="gap-1.5 max-[479px]:h-8">
                  <span>
                    <span className="min-[480px]:hidden" aria-hidden="true">
              ...
              <DropdownMenuContent align="end" className="min-w-32 z-[1300]">
            ...
            <Button
              ...
              className="max-[479px]:aspect-square max-[479px]:p-0! bg-teal-600 hover:bg-teal-500 text-white"
              size="sm"
              onClick={() => {
                setSelectedEvent(null);
                setIsEventDialogOpen(true);
