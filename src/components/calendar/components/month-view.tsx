  ...
  return (
    <div data-slot="month-view" className="contents">
      <div className="border-border/70 grid grid-cols-7 border-b">
        {weekdays.map((day) => (
          <div key={day} className="text-white py-2 text-center text-sm">
            {day}
          </div>
        ))}
      </div>
              ...
              return (
                <div
                  ...
                  <DroppableCell
                    ...
                    <div className="group-data-today:bg-teal-600 group-data-today:text-primary-foreground mt-1 inline-flex size-6 items-center justify-center rounded-full text-sm">
                      {format(day, "d")}
                    </div>
                    <div
                      ...
                      {hasMore && (
                        <Popover modal>
                          ...
                          <PopoverContent
                            align="center"
                            className="max-w-52 p-3 z-[1300] dark"
                            style={
                              {
